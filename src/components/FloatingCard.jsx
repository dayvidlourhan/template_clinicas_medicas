        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-0 md:gap-px bg-white rounded-2xl overflow-hidden shadow-2xl shadow-gray-200/50 border border-gray-100 relative z-40">
            {cardItems.map((item, index) => (
                <div
                    key={index}
                    className={`
            p-8 flex flex-col gap-4 transition-all duration-300 relative overflow-hidden group border-b md:border-b-0 md:border-r border-gray-100 last:border-0 min-h-[240px]
            ${item.bgClass} 
