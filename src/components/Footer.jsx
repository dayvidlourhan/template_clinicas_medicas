                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            ...
                            <li className="flex items-center gap-3 text-gray-300">
                                ...
                                <a href={getWhatsAppLink("Olá, quero agendar uma consulta.")} target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
                                    Agendar no Zap
                                </a>
                            </li>
                        </ul>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li><a href="#convenios" className="footer-link">Convênios</a></li>
                            <li><a href="#sobre" className="footer-link">Sobre Nós</a></li>
                            <li><a href="#" className="footer-link">Política de Privacidade</a></li>
                            <li><a href={`mailto:${clinicConfig.careersEmail}`} className="footer-link">Trabalhe Conosco</a></li>
                        </ul>
                    </div>
